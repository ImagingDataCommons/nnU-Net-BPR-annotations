...
def dc_dict_to_df(dc_dict, structure_name):
  ...
  Argumentss:
    dc_dict - required : dictionary containing the results information. The dictionary
                        should be formatted like the following (eval script output):
    ...
    structure_name - required: name of the structure the Dataframe should be about (e.g., "heart")
...
def hd_dict_to_df(hd_dict, structure_name):
  ...
  """
  Format the Hausdorff Distance results dictionary to a more human-readable Pandas Dataframe.

  
  Arguments:
    hd_dict - required: dictionary containing the results information. The dictionary
                        should be formatted like the following (eval script output):
